...
Некоторые функции связаны с определенным типом. Они бывают двух видов: связанные функции и методы. Связанные функции — это функции, которые обычно определены для типа в целом, а методы — это связанные функции, которые вызываются для конкретного экземпляра типа.
